...
# A simple function to make text appear like a retro computer
...
def main():
    ...
    # 1. Ask the questions (Simulating Requirements Gathering)
    ...
    # 2. The Logic (This proves you understand the tradeoffs)
